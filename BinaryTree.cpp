...
void BinaryTree::Insert(int value) {
    if (value < _rootNode->getValue()) {
        auto child = _rootNode->getLeftChild();
        Insert(value, child);
        _rootNode->setLeftChild(child);
    } else if (value > _rootNode->getValue()) {
        auto child = _rootNode->getRightChild();
        Insert(value, child);
        _rootNode->setRightChild(child);
    }
}
